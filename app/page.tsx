    ...
    <div className="mt-5 flex gap-3 overflow-x-auto pb-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
      {[
        ...
        return (
          <div
            key={company.name}
            className="group flex min-h-[76px] min-w-[110px] flex-1 flex-col items-center justify-center gap-2 rounded-2xl border border-blue-100 bg-gradient-to-b from-blue-50/70 to-white px-3 py-3 transition hover:-translate-y-0.5 hover:border-blue-200 hover:shadow-md"
          >
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-white shadow-sm">
              ...
              <span
                className="hidden h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-br from-blue-600 to-indigo-600 text-[10px] font-black text-white"
                aria-hidden="true"
              >
